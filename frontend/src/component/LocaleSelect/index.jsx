...
export default function LocaleSelect() {
  ...
  return (
    <div
      className="relative flex justify-end w-[44px] h-[44px] pr-[12px] cursor-pointer"
      onClick={localeClicked}
    >
      <Image
        className="rounded-[50%] my-[13.5px] border border-gray03"
        src={localeImg}
        width={18}
        height={18}
        alt="locale"
      ...
      {isClicked && (
        <div className="absolute w-[100px] h-[122px] rounded-[12px] right-2 top-[52px] bg-white border border-gray05 z-50">
          ...
          >
            <Image
              className="rounded-[50%] h-[18px] border border-gray03"
              src={KoLocale}
              width={18}
              height={18}
              alt="ko"
